// Pricing Calculator JavaScript - UPDATED
...
function calculateTotal() {
    ...
    if (emailSecurityToggle.checked) {
        ...
        const calculatedEmail = emailUsers * rates.emailSecurity;
        monthlyCosts.emailSecurity = Math.max(calculatedEmail, minimums.emailSecurity);
    ...
    if (backupToggle.checked) {
        ...
        const calculatedBackup = backupDevices * rates.backup;
        monthlyCosts.backup = Math.max(calculatedBackup, minimums.backup);
